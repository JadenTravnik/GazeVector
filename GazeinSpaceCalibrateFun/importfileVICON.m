function ViconDR1 = importfileVICON(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   VICONDR1 = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   VICONDR1 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   ViconDR1 = importfile('ViconDR1.csv', 6, 5475);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2015/09/21 12:09:25
